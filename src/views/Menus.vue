<template>
  <div class="text-center" v-if="loading">
    <svg role="status" class="inline mt-16 w-44 h-36 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600" viewBox="0 0 100 101"        fill="none" xmlns="http://www.w3.org/2000/svg">

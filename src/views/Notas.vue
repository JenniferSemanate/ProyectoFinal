  ...
  >
    <div class="col-span-3 bg-white shadow-md p-8 rounded-xl py-9">
      ...
      <form class="grid border p-5">
        ...
        <button
          class="border rounded-md py-2 px-4 bg-blue-300 font-semibold hover:text-white"
        >
          Añadir datos
        </button>
      </form>
    ...
    <div class="col-span-3 shadow-md p-8 bg-white rounded-xl py-9">
      ...
      <div class="grid border p-5">
        ...
        <RouterLink
          ...
          class="border rounded-md py-2 px-4 bg-blue-300 font-semibold hover:text-white text-center"
